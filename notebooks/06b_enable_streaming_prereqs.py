...
SELECT
  b.event_month,
  b.anomaly_type,
  COUNT(DISTINCT CONCAT(b.customer_id, '-', b.event_month, '-', b.anomaly_type)) AS total_anomalies,
  COUNT(DISTINCT m.anomaly_id)                                                    AS alerted_count,
  COUNT(DISTINCT CONCAT(b.customer_id, '-', b.event_month, '-', b.anomaly_type))
...
LEFT JOIN {catalog}.{schema}.billing_monitoring_state m
  ON CONCAT(b.customer_id, '-', b.event_month, '-', b.anomaly_type) = m.anomaly_id
